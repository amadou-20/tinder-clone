...
function TinderCards () {
    ...
    const [people, setPeople] = useState([
       ...
       },
       {
         name: "elon musk",
         age: 45,
         url: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRmbjrHSETiMZvep50h9EmQylotRP5U8PYoKQ&usqp=CAU"
 
       },
       {
         name: "jeff bezos",
         age: 56,
         url: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRl9l0B5L7NT0Fg1UVsDGd5e52-V0HNoehbnQ&usqp=CAU"
       },
       {
         name: "joe biden",
         age: 69,
